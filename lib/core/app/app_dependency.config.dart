...
import 'package:medPilot/features/patient_portal/home/repository/home_repository_imp.dart'
    as _i12;
import 'package:medPilot/features/profile/cubit/profile_cubit.dart' as _i21;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i16.ProfileRepositoryImp>(
      () => _i17.ProfileRepository(apiClient: gh<_i13.ApiClient>()));
  gh.factory<_i18.HomeCubit>(() => _i18.HomeCubit(gh<_i11.HomeRepository>()));
  gh.factory<_i19.SignInRepositoryImp>(
      () => _i20.SignInRepository(apiClient: gh<_i13.ApiClient>()));
  gh.factory<_i21.ProfileCubit>(
      () => _i21.ProfileCubit(gh<_i16.ProfileRepositoryImp>()));
  gh.factory<_i22.SignInCubit>(
      () => _i22.SignInCubit(gh<_i19.SignInRepositoryImp>()));
  return getIt;
}
