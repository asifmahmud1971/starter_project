...
import 'package:medPilot/core/app/app_dependency.dart' as _i59;
...
import 'package:medPilot/features/patient_portal/services/wound_clinic/cubit/woundClinic_cubit.dart'
    as _i27;
import 'package:medPilot/features/profile/cubit/profile_cubit.dart' as _i52;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i29.StaffFollowUpCubit>(
      () => _i29.StaffFollowUpCubit(gh<_i13.StaffPortalRepository>()));
  gh.factory<_i30.MedicineAlertCubit>(
      () => _i30.MedicineAlertCubit(gh<_i13.StaffPortalRepository>()));
  gh.factory<_i31.AttendanceCubit>(
      () => _i31.AttendanceCubit(gh<_i13.StaffPortalRepository>()));
  gh.factory<_i32.RosterCubit>(
      () => _i32.RosterCubit(gh<_i13.StaffPortalRepository>()));
  gh.factory<_i33.TaskCubit>(
      () => _i33.TaskCubit(gh<_i13.StaffPortalRepository>()));
  gh.factory<_i34.StaffPrescriptionCubit>(
      () => _i34.StaffPrescriptionCubit(gh<_i13.StaffPortalRepository>()));
  gh.factory<_i35.SignUpRepository>(
      () => _i36.SignUpRepositoryImp(apiRequest: gh<_i10.ApiRequest>()));
  gh.factory<_i37.RehabPallRepositoryImp>(
      () => _i38.RehabPallRepository(apiRequest: gh<_i10.ApiRequest>()));
  gh.factory<_i39.ProfileRepositoryImp>(
      () => _i40.ProfileRepository(apiClient: gh<_i28.ApiClient>()));
  gh.factory<_i41.HomeCubit>(() => _i41.HomeCubit(gh<_i21.HomeRepository>()));
  gh.factory<_i42.CartCubit>(() => _i42.CartCubit(gh<_i17.CartRepository>()));
  gh.factory<_i43.ChatCubit>(() => _i43.ChatCubit(gh<_i15.ChatRepository>()));
  gh.factory<_i44.RehabPallCubit>(
      () => _i44.RehabPallCubit(gh<_i37.RehabPallRepositoryImp>()));
  gh.factory<_i45.SignInRepositoryImp>(
      () => _i46.SignInRepository(apiClient: gh<_i28.ApiClient>()));
  gh.factory<_i47.PsychSocialRepositoryImp>(
      () => _i48.PsychSocialRepository(apiClient: gh<_i28.ApiClient>()));
  gh.factory<_i49.InvestigationRepositoryImp>(
      () => _i50.InvestigationRepository(apiClient: gh<_i28.ApiClient>()));
  gh.factory<_i51.OnDemandServiceCubit>(
      () => _i51.OnDemandServiceCubit(gh<_i19.OnDemandServiceRepository>()));
  gh.factory<_i52.ProfileCubit>(
      () => _i52.ProfileCubit(gh<_i39.ProfileRepositoryImp>()));
  gh.factory<_i53.ForgotPasswordRepositoryImp>(
      () => _i54.ForgotPasswordRepository(apiClient: gh<_i28.ApiClient>()));
  gh.factory<_i55.ForgotPasswordCubit>(
      () => _i55.ForgotPasswordCubit(gh<_i53.ForgotPasswordRepositoryImp>()));
  gh.factory<_i56.PsychSocialCubit>(
      () => _i56.PsychSocialCubit(gh<_i47.PsychSocialRepositoryImp>()));
  gh.factory<_i57.SignInCubit>(
      () => _i57.SignInCubit(gh<_i45.SignInRepositoryImp>()));
  gh.factory<_i58.InvestigationCubit>(
      () => _i58.InvestigationCubit(gh<_i49.InvestigationRepositoryImp>()));
  return getIt;
}
