...
import 'package:medPilot/core/app/app_dependency.dart' as _i45;
...
import 'package:medPilot/features/patient_portal/services/wound_clinic/cubit/woundClinic_cubit.dart'
    as _i21;
import 'package:medPilot/features/profile/cubit/profile_cubit.dart' as _i38;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i33.PsychSocialRepositoryImp>(
      () => _i34.PsychSocialRepository(apiClient: gh<_i22.ApiClient>()));
  gh.factory<_i35.InvestigationRepositoryImp>(
      () => _i36.InvestigationRepository(apiClient: gh<_i22.ApiClient>()));
  gh.factory<_i37.OnDemandServiceCubit>(
      () => _i37.OnDemandServiceCubit(gh<_i13.OnDemandServiceRepository>()));
  gh.factory<_i38.ProfileCubit>(
      () => _i38.ProfileCubit(gh<_i27.ProfileRepositoryImp>()));
  gh.factory<_i39.ForgotPasswordRepositoryImp>(
      () => _i40.ForgotPasswordRepository(apiClient: gh<_i22.ApiClient>()));
  gh.factory<_i41.ForgotPasswordCubit>(
      () => _i41.ForgotPasswordCubit(gh<_i39.ForgotPasswordRepositoryImp>()));
  gh.factory<_i42.PsychSocialCubit>(
      () => _i42.PsychSocialCubit(gh<_i33.PsychSocialRepositoryImp>()));
  gh.factory<_i43.SignInCubit>(
      () => _i43.SignInCubit(gh<_i31.SignInRepositoryImp>()));
  gh.factory<_i44.InvestigationCubit>(
      () => _i44.InvestigationCubit(gh<_i35.InvestigationRepositoryImp>()));
  return getIt;
}
