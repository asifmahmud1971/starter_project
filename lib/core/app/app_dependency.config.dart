...
import 'package:medPilot/core/app/app_dependency.dart' as _i39;
...
import 'package:medPilot/features/patient_portal/services/wound_clinic/cubit/woundClinic_cubit.dart'
    as _i19;
import 'package:medPilot/features/profile/cubit/profile_cubit.dart' as _i33;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i31.InvestigationRepositoryImp>(
      () => _i32.InvestigationRepository(apiClient: gh<_i20.ApiClient>()));
  gh.factory<_i33.ProfileCubit>(
      () => _i33.ProfileCubit(gh<_i25.ProfileRepositoryImp>()));
  gh.factory<_i34.ForgotPasswordRepositoryImp>(
      () => _i35.ForgotPasswordRepository(apiClient: gh<_i20.ApiClient>()));
  gh.factory<_i36.ForgotPasswordCubit>(
      () => _i36.ForgotPasswordCubit(gh<_i34.ForgotPasswordRepositoryImp>()));
  gh.factory<_i37.SignInCubit>(
      () => _i37.SignInCubit(gh<_i29.SignInRepositoryImp>()));
  gh.factory<_i38.InvestigationCubit>(
      () => _i38.InvestigationCubit(gh<_i31.InvestigationRepositoryImp>()));
  return getIt;
}
