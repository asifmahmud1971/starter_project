        ...
        body: BlocBuilder<RehabPallCubit, RehabPallState>(
          builder: (context, state) {
            return GridView.builder(
              ...
              itemCount:
                  state.rehabPallCareResponse?.rehabilitativePallMenu?.length,
              itemBuilder: (context, index) {
                RehabilitativePallMenu? rehabPallMenu = state
                    .rehabPallCareResponse?.rehabilitativePallMenu
                    ?.elementAt(index);
                return InkWell(
                  onTap: () {
                    GetContext.to(RehabPlayVideoList(
                      title: rehabPallMenu?.menuName ?? "",
                    ));
                  },
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Flexible(
                          ...
                          child: Image.network(
                              "https://krishnahospital.in/wp-content/uploads/2019/12/slide-21-1.jpg"),
                        )),
                        5.verticalSpace,
                        Text(
