    ...
    return Scaffold(
      ...
      body: BlocBuilder<RehabPallCubit, RehabPallState>(
        builder: (context, state) {
          return (state.rehabPallVideoResponse?.rehabilitativePallVideo ?? [])
                  .isEmpty
              ? SizedBox()
              : ListView.builder(
                  itemCount: state
                      .rehabPallVideoResponse?.rehabilitativePallVideo?.length,
                  itemBuilder: (context, index) {
                    RehabilitativePallVideo? rehabPallVideo = state
                        .rehabPallVideoResponse?.rehabilitativePallVideo
                        ?.elementAt(index);
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: () => GetContext.to(
                            VideoPlayer(rehabPallVideo: rehabPallVideo)),
                      ),
                    );
                  },
                );
