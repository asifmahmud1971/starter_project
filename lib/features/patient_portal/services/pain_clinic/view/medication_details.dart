...
class AddNewDoseScreen extends StatefulWidget {
  @override
  _AddNewDoseScreenState createState() => _AddNewDoseScreenState();
}

class _AddNewDoseScreenState extends State<AddNewDoseScreen> {
  final List<Map<String, dynamic>> medications = [
    {
      'name': 'Dossinex',
      'dose': '1+0+1',
      'note': 'Every day 6 hourly',
      'duration': '1 week',
      'schedule': [
        {'date': '2023-05-10', 'time': '08:00 AM', 'taken': true},
        {'date': '2023-05-10', 'time': '02:00 PM', 'taken': false},
        {'date': '2023-05-10', 'time': '08:00 PM', 'taken': false},
      ],
    },
    {
      'name': 'Morphane',
      ...
      'duration': '7 days',
      'schedule': [
        {'date': '2023-05-10', 'time': '09:00 AM', 'taken': true},
        {'date': '2023-05-10', 'time': '03:00 PM', 'taken': false},
        {'date': '2023-05-10', 'time': '09:00 PM', 'taken': false},
      ],
    },
  ];
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow('${AppStrings.instructions.tr()}:', med['note']),
              SizedBox(height: 8),
              if (isExpanded) ...[
                ...
                SizedBox(height: 12),
                ...med['schedule'].map<Widget>((schedule) {
